namespace MVCPresentationWithIdentity.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MVCPresentationWithIdentity.Models.ApplicationDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "MVCPresentationWithIdentity.Models.ApplicationDbContext";
        }

        protected override void Seed(MVCPresentationWithIdentity.Models.ApplicationDbContext context)
        {
